...
export function FloatingNav() {
  ...
  return (
    <>
      ...
      >
        <div className="relative px-4 py-3 rounded-full bg-slate-800/80 backdrop-blur-md border border-slate-700/50 shadow-lg">
          ...
          {isMobile ? (
            ...
            <div className="relative flex items-center gap-1">
              ...
              <Button
                size="sm"
                className="ml-2 bg-gradient-to-r from-cyan-500 to-blue-500 hover:from-blue-500 hover:to-cyan-500 border-0 text-white"
              >
                Resume
              </Button>
            </div>
      ...
      {isMobile && (
        ...
        >
          <div className="flex flex-col items-center justify-center h-full">
            ...
            <Button className="mt-6 bg-gradient-to-r from-cyan-500 to-blue-500 hover:from-blue-500 hover:to-cyan-500 border-0 text-white">
              Resume
            </Button>
          </div>
        </motion.div>
